      ...
      <div className="container relative z-10">
        ...
        <div className="mt-16 sm:mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto animate-fade-in [animation-delay:600ms]">
          <a href="https://www.instagram.com/havenatdeerpark/" target="_blank" rel="noopener noreferrer" 
             className="group relative overflow-hidden rounded-2xl bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] p-6 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-pink-500/25 text-white flex flex-col items-center justify-center gap-4 min-h-[140px] md:min-h-[160px]">
             <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors" />
             <div className="relative z-10 p-3 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 group-hover:scale-110 transition-transform">
               <Instagram className="w-7 h-7 md:w-8 md:h-8" />
             </div>
             <h4 className="relative z-10 font-bold text-base md:text-lg tracking-wide">Instagram</h4>
          </a>
          
          <a href="https://www.tiktok.com/@HavenatDeerPark" target="_blank" rel="noopener noreferrer" 
             className="group relative overflow-hidden rounded-2xl bg-gradient-to-tr from-zinc-900 to-[#111111] border border-zinc-800 p-6 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-zinc-900/40 text-white flex flex-col items-center justify-center gap-4 min-h-[140px] md:min-h-[160px]">
             <div className="absolute inset-0 bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity" />
             <div className="relative z-10 p-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform">
             ...
             <h4 className="relative z-10 font-bold text-base md:text-lg tracking-wide">TikTok</h4>
          </a>

          <a href="https://www.facebook.com/havenatdeerpark" target="_blank" rel="noopener noreferrer" 
             className="group relative overflow-hidden rounded-2xl bg-gradient-to-tr from-[#1877F2] to-[#0a5abf] p-6 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-blue-500/25 text-white flex flex-col items-center justify-center gap-4 min-h-[140px] md:min-h-[160px]">
             <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors" />
             <div className="relative z-10 p-3 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 group-hover:scale-110 transition-transform">
               <Facebook className="w-7 h-7 md:w-8 md:h-8" fill="currentColor" />
             </div>
             <h4 className="relative z-10 font-bold text-base md:text-lg tracking-wide">Facebook</h4>
          </a>

          <a href="https://www.youtube.com/@HavenatDeerPark" target="_blank" rel="noopener noreferrer" 
             className="group relative overflow-hidden rounded-2xl bg-gradient-to-tr from-[#FF0000] to-[#cc0000] p-6 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-red-500/25 text-white flex flex-col items-center justify-center gap-4 min-h-[140px] md:min-h-[160px]">
             <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors" />
             <div className="relative z-10 p-3 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 group-hover:scale-110 transition-transform">
               <Youtube className="w-7 h-7 md:w-8 md:h-8" />
             </div>
             <h4 className="relative z-10 font-bold text-base md:text-lg tracking-wide">YouTube</h4>
          </a>
        </div>
      </div>
    </section>
