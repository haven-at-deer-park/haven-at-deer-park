      ...
      <div className="container relative z-10">
        ...
        <div className="mt-16 sm:mt-24 grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto animate-fade-in [animation-delay:400ms]">
          <a href="https://www.instagram.com/havenatdeerpark/" target="_blank" rel="noopener noreferrer" 
             className="group flex flex-col items-center justify-center p-6 gap-3 rounded-2xl bg-card border border-border/50 shadow-sm transition-all hover:shadow-md hover:-translate-y-1 hover:border-pink-500/30">
          ...
          <a href="https://www.tiktok.com/@HavenatDeerPark" target="_blank" rel="noopener noreferrer" 
             className="group flex flex-col items-center justify-center p-6 gap-3 rounded-2xl bg-card border border-border/50 shadow-sm transition-all hover:shadow-md hover:-translate-y-1 hover:border-zinc-500/30">
          ...
          <a href="https://www.facebook.com/havenatdeerpark" target="_blank" rel="noopener noreferrer" 
             className="group flex flex-col items-center justify-center p-6 gap-3 rounded-2xl bg-card border border-border/50 shadow-sm transition-all hover:shadow-md hover:-translate-y-1 hover:border-blue-500/30">
          ...
          <a href="https://www.youtube.com/@HavenatDeerPark" target="_blank" rel="noopener noreferrer" 
             className="group flex flex-col items-center justify-center p-6 gap-3 rounded-2xl bg-card border border-border/50 shadow-sm transition-all hover:shadow-md hover:-translate-y-1 hover:border-red-500/30">
