                ...
                <div className="glass-card p-6 space-y-6 mb-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">+63 981 659 7336</p>
                    </div>
                  </div>
              ...
              <div className="animate-fade-in [animation-delay:300ms]">
                ...
                <div className="mt-6 text-center">
                  <div className="relative flex items-center justify-center mb-4">
                    ...
                    <span className="px-4 text-sm text-muted-foreground">{t.contact.orReachUs}</span>
                    <div className="border-t border-border flex-grow" />
                  </div>
                  <a
                  ...
                  <p className="text-xs text-muted-foreground mt-2">{t.contact.whatsappHint}</p>
                </div>
              </div>
            </div>
          </div>
