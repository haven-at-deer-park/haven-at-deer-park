...
import { Dumbbell, Coffee, Utensils, Wine, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen, Heart, Sparkles } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Heart key={0} />, <Dumbbell key={1} />, <Sparkles key={2} />, <Users key={3} />],
